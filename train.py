...
import math
import time
import random  # FIX: for deterministic seeding
...
if not torch.cuda.is_available():
    raise RuntimeError("CUDA GPU required to run this training script")

from kernels import get_kernel

# FIX: safer capability detection
cap_major, cap_minor = torch.cuda.get_device_capability()
is_hopper = cap_major >= 9
